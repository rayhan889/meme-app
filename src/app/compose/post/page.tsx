...
export default function UploadMeme() {
  ...
  return (
    <div className="flex w-full flex-col gap-y-4 border-b-[1px] border-neutral-800 p-5">
      <div className="flex flex-row items-start justify-start gap-x-4 border-b-[1px] border-neutral-800 py-4">
        <Avatar className="flex h-[48px] w-[48px] items-center justify-center rounded-full">
